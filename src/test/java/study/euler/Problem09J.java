...
public class Problem09J {
    ...
    public void solve() {
        ...
        final Triplet t = findPythagoreanTriplet(sum);
        ...
        // report the results
        logger.info(String.format("The Solution is: %.1f, where a = %d, b = %d, c = %.1f", product, t.a, t.b, t.c));
    }
     ...
     */
    public Triplet findPythagoreanTriplet(final int sum) {
